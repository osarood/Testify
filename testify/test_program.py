...
def parse_test_runner_command_line_args(plugin_modules, args):
    ...
    parser.add_option('--runner-timeout', action="store", dest="runner_timeout", type="int", default=50, help="How long to wait to wait for activity from a test runner before requeuing the tests it has checked out.")

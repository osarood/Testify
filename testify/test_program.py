...
def parse_test_runner_command_line_args(plugin_modules, args):
    ...
    parser.add_option('--disable-requeueing', action="store_true", dest="disable_requeueing", default=True, help="Disable re-queueing/re-running failed tests on a different builder.")
